      ...
      <section className="bg-card rounded-xl p-5 card-shadow space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mb-1">Optional column: <code className="bg-muted px-1 rounded">image_url</code> for contestant photos</p>
            <div className="overflow-x-auto">
              <table className="text-xs w-full border">
                <thead><tr className="bg-muted"><th className="p-2 text-left">week</th><th className="p-2 text-left">episode_date</th><th className="p-2 text-left">contestant_name</th><th className="p-2 text-left">received_rose</th><th className="p-2 text-left">eliminated</th><th className="p-2 text-left">roses_this_week</th><th className="p-2 text-left">image_url</th></tr></thead>
                <tbody><tr className="border-t"><td className="p-2">1</td><td className="p-2">2026-03-22</td><td className="p-2">Emma</td><td className="p-2">true</td><td className="p-2">false</td><td className="p-2">1</td><td className="p-2">(optional)</td></tr></tbody>
              </table>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="overflow-x-auto">
              <table className="text-xs w-full border">
                ...
                <tbody><tr className="border-t"><td className="p-2">2026-03-22</td><td className="p-2">Welcome!</td><td className="p-2">Pool is open</td><td className="p-2">(optional)</td></tr></tbody>
              </table>
            </div>
          </div>

          <div className="bg-secondary/10 border border-secondary/20 rounded-lg p-3 text-sm">
            <p className="font-semibold text-secondary">💡 Single CSV Option</p>
            <p className="text-muted-foreground mt-1">
              You can also use a single CSV with a <code className="bg-muted px-1 rounded text-xs">type</code> column
              containing "player", "pick", "result", or "announcement". Set <code className="bg-muted px-1 rounded text-xs">SINGLE_CSV_URL</code> in config.
            </p>
          </div>
        </div>
      </section>
...
{`DATA_ENDPOINTS: {
  ...
  announcements_csv_url: "https://...",
          ...
          <p>Or for a single CSV:</p>
          <pre className="bg-muted rounded-lg p-3 text-xs overflow-x-auto">
{`SINGLE_CSV_URL: "https://..."`}
          </pre>
        </div>
      </section>
